          ...
          <div className="space-y-5 md:space-y-6">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-5 gap-3.5 md:gap-4">
              ...
              <div className="bg-slate-900 border border-slate-800/80 p-4 md:p-5 rounded-2xl relative overflow-hidden">
                <span className="text-sm md:text-base font-medium text-slate-400 uppercase tracking-wider">Total Clients</span>
              ...
              <div className="bg-slate-900 border border-slate-800/80 p-4 md:p-5 rounded-2xl relative overflow-hidden">
                <span className="text-sm md:text-base font-medium text-slate-400 uppercase tracking-wider">Pipeline</span>
              ...
              {/* Card 3: Avg Deal */}
              <div className="bg-slate-900 border border-slate-800/80 p-4 md:p-5 rounded-2xl relative overflow-hidden">
                <span className="text-sm md:text-base font-medium text-slate-400 uppercase tracking-wider">Avg Deal</span>
              ...
              <div className="bg-slate-900 border border-slate-800/80 p-4 md:p-5 rounded-2xl relative overflow-hidden">
                <span className="text-sm md:text-base font-medium text-slate-400 uppercase tracking-wider">Success Rate</span>
                <h3 className="text-2xl md:text-3xl lg:text-4xl font-light text-white mt-1">
                  {successRate}%
                </h3>
              ...
              <div className="bg-slate-900 border border-slate-800/80 p-4 md:p-5 rounded-2xl relative col-span-2 md:col-span-1">
                <span className="text-sm md:text-base font-medium text-slate-400 uppercase tracking-wider">Access Status</span>
